  ...
  return (
    <>
			...
			<div key={menu.title} className='z-20'>
				<button className={`w-[40px] h-[40px] bottom-3 rounded-full duration-500 ${menu.active ? 'fixed bg-[#4F4F4F] right-[22px]' : 'right-3 hidden'}`} onClick={() => changeActiveMenu(-1)} ></button>
